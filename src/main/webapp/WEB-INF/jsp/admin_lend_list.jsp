        ...
        <table class="table table-hover">
            ...
            <c:forEach items="${list}" var="alog">
                <tr>
                    ...
                    <td>${alog.bookName}</td>
                    <td>${alog.readerId}</td>
                    <td>${alog.readerName}</td>
                    <td>${alog.lendDate}</td>
                    <td>${alog.backDate}</td>
                    <c:if test="${empty alog.backDate}">
                        <td><a href="returnbookNew.action?sernum=${alog.sernum}&bookId=${alog.bookId}">
                            <button type="button" class="btn btn-primary btn-xs">还阅</button>
                        </a></td>
                    </c:if>
                    <c:if test="${!empty alog.backDate}">
                        <td><a href="returnbookNew.action?sernum=${alog.sernum}&bookId=${alog.bookId}">
                            <button type="button" disabled="disabled" class="btn btn-primary btn-xs">已还</button>
                        </a></td>
                    </c:if>

<%--                    <td><fmt:formatDate value="${alog.lendDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>--%>
<%--                    <td><fmt:formatDate value="${alog.backDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>--%>
