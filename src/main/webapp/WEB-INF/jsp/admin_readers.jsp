...
<c:if test="${!empty info}">
    <script>alert("${info}");
    window.location.href = "allreaders.action"</script>
</c:if>
...
<div style="padding: 70px 550px 10px">
    <form method="post" action="queryReaders.action" class="form-inline" id="searchform">
        <div class="input-group">
            <input type="text" placeholder="输入名字" class="form-control" id="search" name="searchWord"
                   class="form-control">
        ...
        <table class="table table-hover">
            ...
            <c:forEach items="${readers}" var="reader">
                <tr>
                    ...
                    <td><a href="reader_edit.action?readerId=${reader.readerId}">
                        <button type="button" class="btn btn-info btn-xs">编辑</button>
                    </a></td>
                    <td><a href="reader_delete.action?readerId=${reader.readerId}">
