...
<html>
<head>
    <title>编辑${classInfo.classId}信息</title>
...
<div class="col-xs-6 col-md-offset-3" style="position: relative;top: 10%">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">编辑${classInfo.classId}信息</h3>
        </div>
        <div class="panel-body">
            <form action="bookType_edit_do.action?id=${classInfo.classId}" method="post" id="bookTypeEdit">

                <div class="input-group">
                    <span class="input-group-addon">图书类型号</span>
                    <input readonly="readonly" type="text" class="form-control" name="classId" id="classId"
